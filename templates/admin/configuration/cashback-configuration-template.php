				...
				[
					...
					'fields' => [
						...
						[
							...
							'description'       => sprintf( esc_html__( 'Archive pages highlighting potential earnings. Use placeholder: %s. Available in the Pro version.', 'wallet-management-for-woocommerce' ), '<strong>{cashback_amount}</strong>' ),
							'field_class'       => [ 'ddfw-upgrade-to-pro-tag-wrapper' ],
							'custom_attributes' => [ 'disabled' => 'disabled' ],
						],
						[
							...
							/* translators: %s: the {cashback_amount} placeholder tag. */
							'description'       => sprintf( esc_html__( 'Individual item pages showing specific cashback. Use placeholder: %s. Available in the Pro version.', 'wallet-management-for-woocommerce' ), '<strong>{cashback_amount}</strong>' ),
							'field_class'       => [ 'ddfw-upgrade-to-pro-tag-wrapper' ],
							'custom_attributes' => [ 'disabled' => 'disabled' ],
						],
						[
